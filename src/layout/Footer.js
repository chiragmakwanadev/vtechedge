  ...
  return (
    <div className="w-full bg-[#1b263b] text-white flex items-start justify-start xl:justify-around padding-x py-[100px] gap-[100px] flex-wrap xl:flex-nowrap">
      <div className="flex flex-col justify-between h-full gap-[20px]">
        ...
        <p className="w-[80%]">
          At VTechEdge, we are committed to being more than just a tech provider
          — we are a strategic partner in your digital transformation journey.
        </p>
        <div
      ...
      <div className="flex flex-col gap-[20px] w-[450px]">
        ...
        <ul className="flex flex-col gap-4">
          ...
          <li>
            <Link href="/services/custom-web-application-development">
          ...
          <li>
            <Link href="/services/business-intelligence-and-process-automation">
