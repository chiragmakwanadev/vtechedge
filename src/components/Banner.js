...
const Banner = ({
  ...
  return (
    <div
      className={`w-full py-12 px-4 sm:px-6 lg:px-8 ${bgColor} ${className} h-[350px] mt-[100px] flex flex-col justify-center relative rounded-b-[50px]`}
      style={{
    ...
    >
      <div className="absolute inset-0 bg-black bg-opacity-80 rounded-b-[50px]" />
