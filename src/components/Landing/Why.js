    ...
    <div className="padding-x py-[50px] flex flex-col gap-[50px]">
      <div className="flex items-center flex-col xl:flex-row gap-[50px]">
        ...
        <div className="w-full xl:w-[50%] flex flex-col gap-[20px]">
          <h2 className="text-[18px] text-[#778da9]">Finance & Invoice Automation for Pharmacies and Enterprises.</h2>
          <h1 className="text-[24px] md:text-[30px] font-medium text-[#0d1b2a]">Streamline Accounting. Eliminate Errors. Scale with Confidence.</h1>
