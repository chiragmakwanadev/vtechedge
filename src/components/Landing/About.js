    ...
    <div className="px-[100px] py-[50px] flex flex-col gap-[50px]">
      <div className="flex items-center gap-[50px]">
        ...
        <div className="w-[40%] flex flex-col gap-[20px]">
          ...
          <p className="text-[18px] text-[#0d1b2a]">
            ...
            deserunt quis veritatis, ipsa adipisci, modi dolore consequatur
            veniam fugit non repellendus quisquam dolorem quae mollitia culpa ea
            optio eaque consectetur?
          </p>
          <p className="text-[18px] text-[#0d1b2a]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere
            deserunt quis veritatis, ipsa adipisci, modi dolore consequatur
      ...
      <div className="bg-[#ececec] p-[50px] text-center rounded-[30px] flex flex-col items-center gap-[20px]">
        ...
        <p className="text-[18px] text-[#0d1b2a] w-[80%] text-center">
          ...
          aperiam, culpa odio enim, molestias similique animi repellat placeat
          reprehenderit inventore id atque. Inventore eum consequatur dolorem
          vel provident optio ad architecto porro pariatur! Soluta, earum!
          Numquam voluptas iusto culpa corporis ut rerum error voluptate
